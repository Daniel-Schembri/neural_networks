...
TODO: Types of environment: Stochastic, deterministic, discrete, etc.
...
\section{DebugDraw}
The debugdraw class is used as a debugging feature to display the physics simulation of Box2D. It uses OpenGL.
As the debugdraw offers basic shapes it is used by the simulator.

To use the debug-draw its important to call 'DrawDebugData()'. This draws every shape in the list of the world.
