...
\begin{figure}
\begin{tikzpicture}[scale=5.3,cap=round,>=latex,rotate=90]
...
\begin{tikzpicture}[scale=5.3,cap=round,>=latex]
    ...
    \draw[blue] (-0.6cm,0.35cm) node[] {$ v_1 = (\frac{-3r}{5}\ \frac{3r}{10})$};
    \draw[blue, ->] (origin) -- (-0.6cm,0.3cm);
    
    \draw[] (0.2cm,0.8cm) node[red] {};
    \draw[red] (0.2cm,0.85cm) node[] {$ v_2 = (\frac{r}{5}\ \frac{4r}{5})$};
...
\begin{tikzpicture}[scale=5.3,cap=round,>=latex]
    ...
    \draw[blue] (0.6cm,0.35cm) node[] {$ v_1' = (\frac{3r}{5}\ \frac{3r}{10})$};
    \draw[blue, ->] (origin) -- (0.6cm,0.3cm);
    \draw[blue] (0.2cm,0.0cm) arc (0:40:0.13);
    \node[blue] (alpha) at (0.15,0.04) {$\alpha$}; 
